...
export type LayerId = 'basemap' | 'basins' | 'rivers' | 'basin_susceptibility' | 'river_network' | 'precip_observed';
...
export const DEFAULT_STATE: SceneState = {
  ...
  activeLayers: ['basemap', 'precip_observed', 'basin_susceptibility', 'river_network', 'basins', 'rivers'],
  time: { valid: 'now' },
