...
async def _run_fetch_snodas_swe(session: AsyncSession, fetcher: ArchivingFetcher) -> int:
    """SNODAS adapted to the JobFn contract; geometry directory from the environment."""
